...
public class AnnouncementServiceImpl implements AnnouncementService{
    ...
    @Autowired
    public AnnouncementServiceImpl(AnnouncementDAO announcementDAO, PropertyDAO propertyDAO, UserDAO userDAO) {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        AnnouncementServiceImpl announcementServiceImpl =new AnnouncementServiceImpl(announcementDAO,propertyDAO,userDAO);
        for (Announcement announcement:announcementServiceImpl.getAllAnnouncements())
